...
var ReactDOM = !(function webpackMissingModule() { var e = new Error("Cannot find module \".\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())();
...
ReactDOM.render(React.createElement(TestApp, null), document.getElementById('ReactContainer'));
